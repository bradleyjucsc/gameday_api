...
class TestGamedayUrlBuilder < MiniTest::Unit::TestCase

  def test_build_eventlog_url
    url = Gameday::GamedayUrlBuilder.build_eventlog_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_boxscore_url
    url = Gameday::GamedayUrlBuilder.build_boxscore_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_game_url
    url = Gameday::GamedayUrlBuilder.build_game_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_gamecenter_url
    url = Gameday::GamedayUrlBuilder.build_gamecenter_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_linescore_url
    url = Gameday::GamedayUrlBuilder.build_linescore_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_players_url
    url = Gameday::GamedayUrlBuilder.build_players_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_batter_url
    url = Gameday::GamedayUrlBuilder.build_batter_url('2009', '9', '20', GAME_ID,'12345')
    assert url
  ...
  def test_build_pitcher_url
    url = Gameday::GamedayUrlBuilder.build_pitcher_url('2009', '9', '20', GAME_ID,'12345')
    assert url
  ...
  def test_build_pbp_inningx_url
    url = Gameday::GamedayUrlBuilder.build_inningx_url('2009', '9', '20', GAME_ID,'3')
    assert url
  ...
  def test_build_pbp_inning_scores_url
    url = Gameday::GamedayUrlBuilder.build_inning_scores_url('2009', '9', '20', GAME_ID)
    assert url
  ...
  def test_build_pbp_inning_hit_url
    url = Gameday::GamedayUrlBuilder.build_inning_hit_url('2009', '9', '20', GAME_ID)
    assert url
